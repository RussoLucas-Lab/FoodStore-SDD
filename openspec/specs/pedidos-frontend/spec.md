# Spec: pedidos-frontend

## Overview
Cubre la interfaz de usuario para que un cliente (rol CLIENT) visualice, consulte y cancele sus pedidos. Incluye la lista paginada de pedidos, la vista de detalle con items y snapshots, el timeline visual de estados y el componente de estado del pago con polling automático.
