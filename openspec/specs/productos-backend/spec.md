...
## Purpose
Backend module for complete product management — CRUD with relations to categories and ingredients, stock/availability control, soft delete, and snapshot pattern for future order processing (Sprint 5).
