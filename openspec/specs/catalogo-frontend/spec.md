# catalogo-frontend Specification

## Purpose
Public product catalog feature — responsive grid with pagination, filterable by category, searchable, allergen exclusion, and skeleton loaders for loading states.
